...
public class A_EntityManagerLifeCycleTests {
     ...
     *  thread-safe한 기능을 요청 소코프마다 생성하기에는 비용(시간, 메모리) 부담이 크므로
     *  application 스코프와 동일하게 싱글톤으로 생성해서 관리하는 것이 효율적이다.
     *  따라서 데이터베이스를 사용하는 애플리케이션 당 한개의 EntituManagerFactory를 생성한다.
     *
     * 필기.
    ...
    * */
    ...
    public void 엔티티_매니저_팩토리와_엔티티_매니저_생명주기_확인1(){
        ...
        System.out.println("entityManager.hasCode: " + entityManager.hashCode());
    }
