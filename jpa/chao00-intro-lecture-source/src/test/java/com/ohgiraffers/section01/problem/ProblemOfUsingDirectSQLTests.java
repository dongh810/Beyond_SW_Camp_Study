...
public class ProblemOfUsingDirectSQLTests {
    ...
    * */
    ...
    /* 설명. 1. 데이터 변환, SQL작성, JDBC API 코드 등의 중복 작성(개발 시간 증가, 유지보수성 저하) */
    ...
    * */
     ...
     *  Menu menu1 = entituManager.find(Menu.class, 12);
     *  Menu menu2 = entituManager.find(Menu.class, 12);
