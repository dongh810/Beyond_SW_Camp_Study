...
public class MenuController {
    ...
    private final PrintResult printResult;  //결과 페이지에 해당하는 (View의 개념의) 클래스
    ...
    public void finMenuByMenuCode(Map<String, String> parameter) {
    ...
    public void registMenu(Map<String, String> parameter) {
        ...
        if(menuService.registMenu(menu)){
            printResult.printSuccessMessage("resgist");
        } else {
