...
public class ClassMappingTestController {
    ...
    public String registMenu(Model model){      // Model은 응당할 페이지의 재료를 담는 객체이다
        System.out.println("/menu/regist 경로의 GET요청 받아보기");

        model.addAttribute("message", "신규 메뉴 등록용 핸들러 메소드 호출함...");

        /* 설명. 핸들러 메소드에서 반환하는 String값은 templates에 있는 view(html 파일)의 이름이다. */
